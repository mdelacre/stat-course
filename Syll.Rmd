...
_Reproduction du nuage de points représentant la relation entre la note à un cours de math et la note à un cours de géographie_  
```{r echo=FALSE, results='asis'}
