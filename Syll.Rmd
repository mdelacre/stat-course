...
table3.1_brut= "Table 3.2.1"     # Données brutes correspondant au nombre d'enfants par ménage
table3.1_freq= "Table 3.2.2"     # Données transnumérisées correspondant au nombre d'enfants par ménage
fumeur_degres = "Table 3.2.3"  # degrés pour le diagramme circulaire
data3.1_degres="Table3.3"

table3.2_freq="Table 3.4.1"      # PIB par habitant et par pays
table3.3_freq_a="Table 3.5.1"    # âge des habitants (catégories homogènes)
table3.3_freq_b="Table 3.5.2"    # âge des habitants (catégories non homogènes)

table3.4_brut="Table 3.6"
table3.5_brut="Table 3.7"

table3.6_serie1="Table 3.8.1"
table3.6_serie2="Table 3.8.2"
table3.6_serie3="Table 3.8.3"
...
barplot_fumeur_freq="Figure 3.1.1"
pie_fumeur_freq="Figure 3.1.2"

barplot_data3.1_freq="Figure 3.2.1" # barplot des fréquences de la variable nombre d'enfants
pie_data3.1_freq="Figure 3.2.2"     # pie chart des fréquences de la variable nombre d'enfants
stair_data3.1_freq="Figure 3.2.3"   # diagramme en escalier des fréquences de la variable nombre d'enfants

barplot_data3.2_freq="Figure 3.3a"  
barplot_data3.3_freq_a="Figure 3.4.1a"   # diagramme en escalier des fréquences de la variable nombre d'enfants
barplot_data3.3_freq_b="Figure 3.4.2a"   # diagramme en escalier des fréquences de la variable nombre d'enfants

polygone_data3.2_freq="Figure 3.3b"  
polygone_data3.3_freq_a="Figure 3.4.1b"   # diagramme en escalier des fréquences de la variable nombre d'enfants
polygone_data3.3_freq_b="Figure 3.4.2b"   # diagramme en escalier des fréquences de la variable nombre d'enfants

boxplot_serie1="Figure 3.5"
...
par(mfrow=c(1,2),mar=c(2,2,2,2),xpd=TRUE)
...
Les histogrammes des effectifs (ou fréquences) cumulées ressemblet aux diagrammes en escalier, si ce n'est que cette fois, les différents bâtons sont collés les uns aux autres pour rendre compte du caractère continu de la variable. 
...
```{r cumpolygon_PIB3, echo=FALSE}
par(mfrow=c(1,3))
Newexemple=rnorm(10000000,0,5)
hist(Newexemple,breaks=nb_categ_Age_a)
hist(Newexemple,breaks=nb_categ_Age_a*5)
hist(Newexemple,breaks=nb_categ_Age_a*10000)
```
...
Ici, ne pas leur demander de le calculer (sans intérêt). Plutôt leur demander de savoir interpréter.
